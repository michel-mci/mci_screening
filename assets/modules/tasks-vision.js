...
let i, s;
const o = typeof TextDecoder != "undefined";
let a;
const h = typeof TextEncoder != "undefined";
function c(t2) {
  if (h)
...
function T(t2) {
  ...
  return function(t3, e3) {
    ...
    for (var r3 = 0; ; ) {
      ...
      if (a2 === 64 && i3 === -1)
        break;
      e3(i3 << 2 | s2 >> 4), o2 != 64 && (e3(s2 << 4 & 240 | o2 >> 2), a2 != 64 && e3(o2 << 6 & 192 | a2));
    }
  }(t2, function(t3) {
    r2[i2++] = t3;
...
var b = typeof Uint8Array != "undefined", k = !v && typeof btoa == "function";
function x(t2) {
  if (!k) {
    var e2;
    e2 === void 0 && (e2 = 0), A(), e2 = E[e2];
...
function M(t2) {
  return b && t2 != null && t2 instanceof Uint8Array;
}
let P;
function C() {
...
function N(t2) {
  U(O);
  var e2 = t2.g;
  return (e2 = e2 == null || M(e2) ? e2 : typeof e2 == "string" ? R(e2) : null) == null ? e2 : t2.g = e2;
}
var B = class {
  constructor(t2, e2) {
    if (U(e2), this.g = t2, t2 != null && t2.length === 0)
...
const W = typeof Uint8Array.prototype.slice == "function";
let z, K = 0, Y = 0;
function $(t2) {
  const e2 = 0 > t2;
...
function Z(t2, e2) {
  ...
  return n2 && (e2 = ~e2 >>> 0, (t2 = 1 + ~t2 >>> 0) == 0 && (e2 = e2 + 1 >>> 0)), t2 = J(t2, e2), n2 ? -t2 : t2;
}
function Q(t2, e2) {
...
function pt(t2, e2) {
  if (e2 == 0)
    return D();
  var n2 = ft(t2, e2);
  return t2.ca && t2.m ? n2 = t2.h.subarray(n2, n2 + e2) : (t2 = t2.h, n2 = n2 === (e2 = n2 + e2) ? C() : W ? t2.slice(n2, e2) : new Uint8Array(t2.subarray(n2, e2))), n2.length == 0 ? D() : new B(n2, O);
}
var gt = [];
function mt(t2) {
  var e2 = t2.g;
...
function vt(t2) {
  ...
  if (t2 = t2.h, o) {
    var h2, c2 = t2;
    (h2 = s) || (h2 = s = new TextDecoder("utf-8", {fatal: true})), e2 = a2 + e2, c2 = a2 === 0 && e2 === c2.length ? c2 : c2.subarray(a2, e2);
    try {
      var u2 = h2.decode(c2);
    } catch (t3) {
      if (i === void 0) {
    ...
    for (; u2 < e2; ) {
      var l2 = t2[u2++];
      128 > l2 ? a2.push(l2) : 224 > l2 ? u2 >= e2 ? n() : (i2 = t2[u2++], 194 > l2 || (192 & i2) != 128 ? (u2--, n()) : a2.push((31 & l2) << 6 | 63 & i2)) : 240 > l2 ? u2 >= e2 - 1 ? n() : (i2 = t2[u2++], (192 & i2) != 128 || l2 === 224 && 160 > i2 || l2 === 237 && 160 <= i2 || (192 & (h2 = t2[u2++])) != 128 ? (u2--, n()) : a2.push((15 & l2) << 12 | (63 & i2) << 6 | 63 & h2)) : 244 >= l2 ? u2 >= e2 - 2 ? n() : (i2 = t2[u2++], (192 & i2) != 128 || i2 - 144 + (l2 << 28) >> 30 != 0 || (192 & (h2 = t2[u2++])) != 128 || (192 & (c2 = t2[u2++])) != 128 ? (u2--, n()) : (l2 = (7 & l2) << 18 | (63 & i2) << 12 | (63 & h2) << 6 | 63 & c2, l2 -= 65536, a2.push(55296 + (l2 >> 10 & 1023), 56320 + (1023 & l2)))) : n(), 8192 <= a2.length && (s2 = r(s2, a2), a2.length = 0);
    }
    u2 = r(s2, a2);
  }
  return u2;
...
function Nt(t2, e2, n2, r2) {
  n2 != null && (e2 = It(t2, e2), r2(n2, t2), Ut(t2, e2));
}
class Bt {
...
var $t = Vt ? (t2) => 0 | t2[Vt] : (t2) => 0 | t2.g, qt = Vt ? (t2) => t2[Vt] : (t2) => t2.g, Jt = Vt ? (t2, e2) => (t2[Vt] = e2, t2) : (t2, e2) => (t2.g !== void 0 ? t2.g = e2 : Object.defineProperties(t2, {g: {value: e2, configurable: true, writable: true, enumerable: false}}), t2);
function Zt(t2) {
  return zt(t2, 34), t2;
}
function Qt(t2, e2) {
...
var ne, re = {}, ie = {};
function se(t2) {
  return !(!t2 || typeof t2 != "object" || t2.Ja !== ie);
}
function oe(t2) {
...
function Te(t2) {
  const e2 = typeof t2;
  return e2 === "number" ? Number.isFinite(t2) : e2 === "string" && we.test(t2);
}
function Ae(t2) {
  if (t2 == null)
    return t2;
...
function be(t2) {
  ...
  return typeof t2 == "number" && Number.isFinite(t2) ? t2 >>> 0 : void 0;
}
function ke(t2) {
...
function Le(t2) {
  ...
  return Number.isSafeInteger(e2) ? String(e2) : ((e2 = t2.indexOf(".")) !== -1 && (t2 = t2.substring(0, e2)), xe(t2) || (nt(t2), t2 = et()), t2);
}
function Fe(t2) {
  return t2 == null ? t2 : Te(t2) ? typeof t2 == "number" ? Se(t2) : Le(t2) : void 0;
}
function Re(t2) {
  if (typeof t2 != "string")
    throw Error();
...
function Ce(t2, e2, n2, r2) {
  if (t2 != null && typeof t2 == "object" && t2.X === re)
    return t2;
  if (!Array.isArray(t2))
    return n2 ? 2 & r2 ? (t2 = e2[Xt]) ? e2 = t2 : (Zt((t2 = new e2()).s), e2 = e2[Xt] = t2) : e2 = new e2() : e2 = void 0, e2;
  let i2 = n2 = $t(t2);
  return i2 === 0 && (i2 |= 32 & r2), i2 |= 2 & r2, i2 !== n2 && Jt(t2, i2), new e2(t2);
}
function Oe(t2, e2, n2) {
  if (e2) {
    ...
    if (!Te(e2 = t2))
      throw _e("int64");
    typeof e2 == "string" ? r2 = Le(e2) : r2 ? (r2 = Math.trunc(e2), Number.isSafeInteger(r2) ? r2 = String(r2) : xe(e2 = String(r2)) ? r2 = e2 : ($(r2), r2 = et())) : r2 = Se(e2);
  } else
    r2 = Fe(t2);
...
function Ne(t2) {
  switch (typeof t2) {
    ...
    case "number":
      return 0 < t2 ? void 0 : t2 === 0 ? De || (De = [0, void 0]) : [-t2, void 0];
    case "string":
      return [0, t2];
    case "object":
      return t2;
...
function Ge(t2, e2, n2) {
  if (t2 == null && (t2 = Ie), Ie = void 0, t2 == null) {
    var r2 = 96;
...
var Ke = class extends He {
  constructor(t2, e2, n2 = We, r2 = We) {
    ...
    for (let s2 = 0; s2 < t2.length; s2++) {
      ...
      let h2 = o2[1];
      e2 ? h2 === void 0 && (h2 = null) : h2 = r2(o2[1], false, true, void 0, void 0, i2), super.set(a2, h2);
    }
  }
  oa(t2 = $e) {
    if (this.size !== 0)
  ...
  set(t2, e2) {
    return ze(this), (t2 = this.S(t2, true, false)) == null ? this : e2 == null ? (super.delete(t2), this) : super.set(t2, this.Z(e2, true, true, this.U, false, this.N));
  }
  Oa(t2) {
    const e2 = this.S(t2[0], false, true);
    t2 = t2[1], t2 = this.U ? t2 === void 0 ? null : t2 : this.Z(t2, false, true, void 0, false, this.N), super.set(e2, t2);
  }
  has(t2) {
...
function Qe(t2, e2, n2, r2, i2) {
  if (t2 != null) {
    if (Array.isArray(t2))
      t2 = he(t2, void 0, 0) ? void 0 : i2 && 2 & $t(t2) ? t2 : tn(t2, e2, n2, r2 !== void 0, i2);
    else if (oe(t2)) {
      const s2 = {};
      for (let o2 in t2)
      ...
      case "object":
        if (t3)
          if (Array.isArray(t3)) {
            ...
            if (t3 instanceof B) {
              const e2 = t3.g;
              return e2 == null ? "" : typeof e2 == "string" ? e2 : t3.g = x(e2);
            }
            if (t3 instanceof Ke)
              return t3.oa();
          }
...
function rn(t2, e2, n2 = te) {
  if (t2 != null) {
    ...
    if (Array.isArray(t2)) {
      var r2 = $t(t2);
      return 2 & r2 || (e2 && (e2 = r2 === 0 || !!(32 & r2) && !(64 & r2 || !(16 & r2))), t2 = e2 ? Jt(t2, -12293 & (34 | r2)) : tn(t2, rn, 4 & r2 ? te : n2, true, true)), t2;
    }
...
function hn(t2, e2, n2, r2) {
  return !(4 & e2) || n2 != null && (!r2 && n2 === 0 && (4096 & e2 || 8192 & e2) && 5 > (t2.constructor[Wt] = 1 + (0 | t2.constructor[Wt])) && ye(), n2 !== 0 && !(n2 & e2));
}
function cn(t2, e2) {
...
function ln(t2, e2, n2, r2) {
  ...
  if (!(n2 >= i2)) {
    var s2 = t2.length;
    return r2 && 256 & e2 && (r2 = t2[s2 - 1][n2]) != null ? (un(t2, e2, i2, n2) && Ht != null && (4 <= (e2 = (t2 = pe != null ? pe : pe = {})[Ht] || 0) || (t2[Ht] = e2 + 1, ye())), r2) : un(t2, e2, i2, n2);
  }
...
function pn(t2, e2, n2, r2, i2) {
  ...
  const h2 = !!(32 & e2);
  let c2 = $t(o2);
  return c2 !== 0 || !h2 || s2 || a2 ? 1 & c2 || (c2 |= 1, Jt(o2, c2)) : (c2 |= 33, Jt(o2, c2)), s2 ? (t2 = false, 2 & c2 || (Zt(o2), t2 = !!(4 & c2)), (r2 || t2) && Object.freeze(o2)) : (s2 = !!(2 & c2) || !!(2048 & c2), r2 && s2 ? (o2 = Gt(o2), r2 = 1, h2 && !a2 && (r2 |= 32), Jt(o2, r2), fn(t2, e2, n2, o2, i2)) : a2 && 32 & c2 && !s2 && Kt(o2, 32)), o2;
}
function gn(t2, e2) {
  t2 = t2.s;
  let n2 = qt(t2);
  const r2 = ln(t2, n2, e2), i2 = ve(r2);
  return i2 != null && i2 !== r2 && fn(t2, n2, e2, i2), i2;
}
function mn(t2) {
  t2 = t2.s;
  let e2 = qt(t2);
  const n2 = ln(t2, e2, 1), r2 = ae(n2, true, !!(34 & e2));
  return r2 != null && r2 !== n2 && fn(t2, e2, 1, r2), r2;
}
function yn(t2, e2, n2) {
  ...
  return En(a2) || (n2 = a2, (a2 = (t2 = s2 === 1 || s2 === 4 && !!(32 & a2)) ? Yt(a2, 2, true) : Un(a2, i2, false)) !== n2 && Jt(o2, a2), t2 && Object.freeze(o2)), s2 === 2 && En(a2) && (o2 = Gt(o2), a2 = Un(a2 = In(a2, i2), i2, false), Jt(o2, a2), fn(r2, i2, e2, o2)), o2;
}
function _n(t2, e2, n2) {
  return t2 = ln(t2, e2, n2), Array.isArray(t2) ? t2 : ne;
}
function vn(t2, e2) {
  return t2 === 0 && (t2 = In(t2, e2)), Yt(t2, 1, true);
}
function En(t2) {
...
function An(t2, e2, n2, r2) {
  t2 = t2.s;
  let i2 = qt(t2);
  ue(i2), fn(t2, i2, e2, (r2 === "0" ? Number(n2) === 0 : n2 === r2) ? void 0 : n2);
}
...
function Sn(t2, e2, n2) {
  ...
  for (let i2 = 0; i2 < n2.length; i2++) {
    const s2 = n2[i2];
    ln(t2, e2, s2) != null && (r2 !== 0 && (e2 = fn(t2, e2, r2)), r2 = s2);
  }
  return r2;
}
function Ln(t2, e2, n2, r2) {
...
function Fn(t2, e2, n2, r2) {
  ...
  let i2 = qt(t2);
  const s2 = ln(t2, i2, n2, r2);
  return (e2 = Ce(s2, e2, false, i2)) !== s2 && e2 != null && fn(t2, i2, n2, e2, r2), e2;
}
function Rn(t2, e2, n2, r2 = false) {
  if ((e2 = Fn(t2, e2, n2, r2)) == null)
    return e2;
  t2 = t2.s;
  let i2 = qt(t2);
  if (!(2 & i2)) {
...
function Mn(t2, e2, n2, r2, i2, s2) {
  ...
  if (s2 && !(8 & h2 || !a2.length && (o2 === 1 || o2 === 4 && 32 & h2))) {
  ...
  return En(h2) || (n2 = h2, (h2 = (s2 = o2 === 1 || o2 === 4 && !!(32 & h2)) ? Yt(h2, !a2.length || 16 & h2 && (!c2 || 32 & h2) ? 2 : 2048, true) : Un(h2, e2, i2)) !== n2 && Jt(a2, h2), s2 && Object.freeze(a2)), o2 === 2 && En(h2) && (a2 = Gt(a2), h2 = Un(h2 = In(h2, e2), e2, i2), Jt(a2, h2), fn(t2, e2, r2, a2)), a2;
}
...
function Cn(t2, e2, n2, r2, i2) {
  return r2 == null && (r2 = void 0), dn(t2, n2, r2, i2);
}
function On(t2, e2, n2, r2) {
  r2 == null && (r2 = void 0), t2 = t2.s;
  let i2 = qt(t2);
  ue(i2), (n2 = Sn(t2, i2, n2)) && n2 !== e2 && r2 != null && (i2 = fn(t2, i2, n2)), fn(t2, i2, e2, r2);
}
function In(t2, e2) {
...
function Dn(t2, e2, n2, r2) {
  t2 = t2.s;
  const i2 = qt(t2);
  ue(i2), e2 = Mn(t2, i2, n2, e2, true), n2 = r2 != null ? r2 : new n2(), e2.push(n2), 2 & $t(n2.s) ? Kt(e2, 8) : Kt(e2, 16);
}
function Nn(t2, e2) {
  return Ae(cn(t2, e2));
}
...
function Kn(t2, e2, n2) {
  ...
  if (oe(n2 = e2[t2 - 1])) {
    t: {
      ...
      for (var h2 in a2) {
        ...
        if (Array.isArray(n3)) {
          let t4 = n3;
          (he(n3, r2, +h2) || se(n3) && n3.size === 0) && (n3 = null), n3 != t4 && (e3 = true);
        }
  ...
  for (h2 = +!!(512 & i2) - 1; 0 < t2 && (n2 = e2[c2 = t2 - 1], c2 -= h2, n2 == null || he(n2, r2, c2) || se(n2) && n2.size === 0); t2--)
    o2 = true;
...
function rr(t2, e2, n2) {
  ...
  if (r2) {
    const n3 = r2[nr];
    i2 = n3 ? n3.T : Ne(r2[0]), t2[e2] = n3 != null ? n3 : r2;
  }
  i2 && i2 === Ue ? (t2.g || (t2.g = new Set())).add(e2) : n2[0] && (t2.h || (t2.h = new Set())).add(e2);
}
function ir(t2, e2) {
...
function ar(t2, e2, n2, r2, i2 = or) {
  ...
  let s2 = 0;
  var o2 = t2[++s2];
  o2 && o2.constructor === Object && (e2.ea = o2, typeof (o2 = t2[++s2]) == "function" && (e2.l = o2, e2.m = t2[++s2], o2 = t2[++s2]));
  const a2 = {};
  ...
  for (h2 = 1; o2 !== void 0; ) {
    let l2;
    typeof o2 == "number" && (h2 += o2, o2 = t2[++s2]);
    var c2 = void 0;
    ...
    for (u2 = h2 + 1, typeof (o2 = t2[++s2]) == "number" && 0 > o2 && (u2 -= o2, o2 = t2[++s2]); h2 < u2; h2++) {
      const t3 = a2[h2];
...
function Er(t2, e2, n2) {
  ...
  if (256 & r2) {
    r2 = t2[s2 - 1];
    for (let t3 in r2)
      i2 = +t3, Number.isNaN(i2) || (s2 = r2[t3]) != null && (a2 = vr(n2, i2)) && a2(e2, s2, i2);
  }
...
var kr = Ar(function(t2, e2, n2, r2, i2) {
  return t2.h === 2 && (t2 = _t(t2, Be([void 0, void 0], r2), i2), ue(r2 = qt(e2)), (i2 = ln(e2, r2, n2)) instanceof Ke ? (2 & i2.N) != 0 ? ((i2 = i2.Y()).push(t2), fn(e2, r2, n2, i2)) : i2.Oa(t2) : Array.isArray(i2) ? (2 & $t(i2) && fn(e2, r2, n2, i2 = wn(i2)), i2.push(t2)) : fn(e2, r2, n2, [t2]), true);
...
function xr(t2, e2, n2) {
  ...
  e2 != null && (typeof e2 == "string" && xt(e2), e2 != null && (Ot(t2, n2, 0), typeof e2 == "number" ? (t2 = t2.g, $(e2), Ft(t2, K, Y)) : (n2 = xt(e2), Ft(t2.g, n2.h, n2.g))));
}
function Sr(t2, e2, n2) {
  (e2 = Ae(e2)) != null && e2 != null && (Ot(t2, n2, 0), Mt(t2.g, e2));
}
function Lr(t2, e2, n2) {
  (e2 = Ee(e2)) != null && (Ot(t2, n2, 0), t2.g.g.push(e2 ? 1 : 0));
}
function Fr(t2, e2, n2) {
  (e2 = Pe(e2)) != null && Dt(t2, n2, c(e2));
}
function Rr(t2, e2, n2, r2, i2) {
  Nt(t2, n2, e2 instanceof zn ? e2.s : Array.isArray(e2) ? Be(e2, r2) : void 0, i2);
}
function Mr(t2, e2, n2) {
  (e2 = e2 == null || typeof e2 == "string" || M(e2) || e2 instanceof B ? e2 : void 0) != null && Dt(t2, n2, X(e2).buffer);
}
function Pr(t2, e2, n2) {
  return (t2.h === 5 || t2.h === 2) && (e2 = pn(e2, qt(e2), n2, 2, false), t2.h == 2 ? wt(t2, ct, e2) : e2.push(ct(t2.g)), true);
}
var Cr, Or = wr(function(t2, e2, n2) {
  ...
  r2 = 2 * (i2 >> 31) + 1;
  const s2 = i2 >>> 20 & 2047;
  return t2 = 4294967296 * (1048575 & i2) + t2, br(e2, n2, s2 == 2047 ? t2 ? NaN : 1 / 0 * r2 : s2 == 0 ? r2 * Math.pow(2, -1074) * t2 : r2 * Math.pow(2, s2 - 1075) * (t2 + 4503599627370496)), true;
}, function(t2, e2, n2) {
  (e2 = ve(e2)) != null && (Ot(t2, n2, 1), t2 = t2.g, (n2 = z || (z = new DataView(new ArrayBuffer(8)))).setFloat64(0, +e2, true), K = n2.getUint32(0, true), Y = n2.getUint32(4, true), Pt(t2, K), Pt(t2, Y));
}), Ir = wr(function(t2, e2, n2) {
  return t2.h === 5 && (br(e2, n2, ct(t2.g)), true);
}, function(t2, e2, n2) {
  (e2 = ve(e2)) != null && (Ot(t2, n2, 5), t2 = t2.g, q(e2), Pt(t2, K));
}), Ur = Tr(Pr, function(t2, e2, n2) {
  if ((e2 = $n(ve, e2)) != null)
    for (let o2 = 0; o2 < e2.length; o2++) {
      var r2 = t2, i2 = n2, s2 = e2[o2];
      s2 != null && (Ot(r2, i2, 5), r2 = r2.g, q(s2), Pt(r2, K));
    }
}), Dr = Tr(Pr, function(t2, e2, n2) {
  if ((e2 = $n(ve, e2)) != null && e2.length) {
    Ot(t2, n2, 2), Rt(t2.g, 4 * e2.length);
    for (let r2 = 0; r2 < e2.length; r2++)
      n2 = t2.g, q(e2[r2]), Pt(n2, K);
  }
}), Nr = wr(function(t2, e2, n2) {
  return t2.h === 0 && (br(e2, n2, it(t2.g, Z)), true);
}, xr), Br = wr(function(t2, e2, n2) {
  return t2.h === 0 && (br(e2, n2, (t2 = it(t2.g, Z)) === 0 ? void 0 : t2), true);
}, xr), Gr = wr(function(t2, e2, n2) {
  return t2.h === 0 && (br(e2, n2, it(t2.g, J)), true);
}, function(t2, e2, n2) {
  t:
    if (e2 != null) {
      if (Te(e2)) {
        if (typeof e2 == "string") {
          ...
          Number.isSafeInteger(r2) && 0 <= r2 ? e2 = String(r2) : ((r2 = e2.indexOf(".")) !== -1 && (e2 = e2.substring(0, r2)), ke(e2) || (nt(e2), e2 = Q(K, Y)));
          break t;
        }
        if (typeof e2 == "number") {
  ...
  e2 != null && (typeof e2 == "string" && At(e2), e2 != null && (Ot(t2, n2, 0), typeof e2 == "number" ? (t2 = t2.g, $(e2), Ft(t2, K, Y)) : (n2 = At(e2), Ft(t2.g, n2.h, n2.g))));
}), jr = wr(function(t2, e2, n2) {
  return t2.h === 0 && (br(e2, n2, ot(t2.g)), true);
}, Sr), Vr = Tr(function(t2, e2, n2) {
  return (t2.h === 0 || t2.h === 2) && (e2 = pn(e2, qt(e2), n2, 2, false), t2.h == 2 ? wt(t2, ot, e2) : e2.push(ot(t2.g)), true);
}, function(t2, e2, n2) {
  if ((e2 = $n(Ae, e2)) != null && e2.length) {
    n2 = It(t2, n2);
  ...
  return t2.h === 0 && (br(e2, n2, (t2 = ot(t2.g)) === 0 ? void 0 : t2), true);
}, Sr), Hr = wr(function(t2, e2, n2) {
  return t2.h === 0 && (br(e2, n2, st(t2.g)), true);
}, Lr), Wr = wr(function(t2, e2, n2) {
  return t2.h === 0 && (br(e2, n2, (t2 = st(t2.g)) === false ? void 0 : t2), true);
}, Lr), zr = Tr(function(t2, e2, n2) {
  return t2.h === 2 && (bn(e2, n2, kn, t2 = vt(t2)), true);
}, function(t2, e2, n2) {
  if ((e2 = $n(Pe, e2)) != null)
    for (let o2 = 0; o2 < e2.length; o2++) {
      var r2 = t2, i2 = n2, s2 = e2[o2];
      s2 != null && Dt(r2, i2, c(s2));
    }
}), Kr = wr(function(t2, e2, n2) {
  return t2.h === 2 && (br(e2, n2, (t2 = vt(t2)) === "" ? void 0 : t2), true);
}, Fr), Yr = wr(function(t2, e2, n2) {
  return t2.h === 2 && (br(e2, n2, vt(t2)), true);
}, Fr), $r = Ar(function(t2, e2, n2, r2, i2) {
  return t2.h === 2 && (_t(t2, Ln(e2, r2, n2, true), i2), true);
}, Rr), qr = Ar(function(t2, e2, n2, r2, i2) {
  return t2.h === 2 && (_t(t2, Ln(e2, r2, n2), i2), true);
}, Rr);
...
var Jr = Ar(function(t2, e2, n2, r2, i2, s2) {
  ...
  return t2.h === 2 && (br(e2, n2, Et(t2)), true);
}, Mr), Qr = Tr(function(t2, e2, n2) {
  return (t2.h === 0 || t2.h === 2) && (e2 = pn(e2, qt(e2), n2, 2, false), t2.h == 2 ? wt(t2, at, e2) : e2.push(at(t2.g)), true);
}, function(t2, e2, n2) {
  if ((e2 = $n(be, e2)) != null)
    for (let o2 = 0; o2 < e2.length; o2++) {
      var r2 = t2, i2 = n2, s2 = e2[o2];
      s2 != null && (Ot(r2, i2, 0), Rt(r2.g, s2));
    }
}), ti = wr(function(t2, e2, n2) {
  return t2.h === 0 && (br(e2, n2, ot(t2.g)), true);
}, function(t2, e2, n2) {
  (e2 = Ae(e2)) != null && (e2 = parseInt(e2, 10), Ot(t2, n2, 0), Mt(t2.g, e2));
}), ei = Tr(function(t2, e2, n2) {
  return (t2.h === 0 || t2.h === 2) && (e2 = pn(e2, qt(e2), n2, 2, false), t2.h == 2 ? wt(t2, ut, e2) : e2.push(ot(t2.g)), true);
}, function(t2, e2, n2) {
  if ((e2 = $n(Ae, e2)) != null && e2.length) {
    n2 = It(t2, n2);
    for (let n3 = 0; n3 < e2.length; n3++)
...
var oi = class extends zn {
  ...
  return t2.h === 2 && (br(e2, n2, (t2 = Et(t2)) === D() ? void 0 : t2), true);
}, function(t2, e2, n2) {
  if (e2 != null) {
    if (e2 instanceof zn) {
      const r2 = e2.Qa;
      return void (r2 && (e2 = r2(e2), e2 != null && Dt(t2, n2, X(e2).buffer)));
    }
    if (Array.isArray(e2))
      return;
  }
...
var xs = [0, Yr, jr, Ir, zr, -1], Ss = class extends zn {
  ...
  g() {
    var _a2;
    return (_a2 = Ee(cn(this, 2))) != null ? _a2 : false;
  }
...
var ko = ri(458105876, class extends zn {
  ...
  g() {
    ...
    }(t2, e2, ln(t2, e2, 2)), t2 == null || !n2 && bo && (t2.ta = true), n2 = t2;
  }
});
...
function Po(t2, e2) {
  return e2 = e2 ? e2.clone() : new ks(), t2.displayNamesLocale !== void 0 ? dn(e2, 1, Me(t2.displayNamesLocale)) : t2.displayNamesLocale === void 0 && dn(e2, 1), t2.maxResults !== void 0 ? Xn(e2, 2, t2.maxResults) : "maxResults" in t2 && dn(e2, 2), t2.scoreThreshold !== void 0 ? Hn(e2, 3, t2.scoreThreshold) : "scoreThreshold" in t2 && dn(e2, 3), t2.categoryAllowlist !== void 0 ? Tn(e2, 4, t2.categoryAllowlist) : "categoryAllowlist" in t2 && dn(e2, 4), t2.categoryDenylist !== void 0 ? Tn(e2, 5, t2.categoryDenylist) : "categoryDenylist" in t2 && dn(e2, 5), e2;
}
function Co(t2, e2 = -1, n2 = "") {
  return {categories: t2.map((t3) => {
    var _a2, _b, _c, _d;
    return {index: (_a2 = Bn(Nn(t3, 1), 0)) != null ? _a2 : -1, score: (_b = Gn(t3, 2)) != null ? _b : 0, categoryName: (_c = jn(t3, 3)) != null ? _c : "", displayName: (_d = jn(t3, 4)) != null ? _d : ""};
...
function Oo(t2) {
  ...
  for (let t3 = 0; t3 < e2.length; t3++)
    s2.categories.push({score: e2[t3], index: (_a2 = n2[t3]) != null ? _a2 : -1, categoryName: (_b = r2[t3]) != null ? _b : "", displayName: (_c = i2[t3]) != null ? _c : ""});
  if ((e2 = (_d = Rn(t2, Qi, 4)) == null ? void 0 : _d.h()) && (s2.boundingBox = {originX: (_e2 = Nn(e2, 1)) != null ? _e2 : 0, originY: (_f = Nn(e2, 2)) != null ? _f : 0, width: (_g = Nn(e2, 3)) != null ? _g : 0, height: (_h2 = Nn(e2, 4)) != null ? _h2 : 0, angle: 0}), (_i2 = Rn(t2, Qi, 4)) == null ? void 0 : _i2.g().length)
    for (const e3 of Rn(t2, Qi, 4).g())
      s2.keypoints.push({x: (_j = gn(e3, 1)) != null ? _j : 0, y: (_k = gn(e3, 2)) != null ? _k : 0, score: (_l = gn(e3, 4)) != null ? _l : 0, label: (_m = Pe(cn(e3, 3))) != null ? _m : ""});
  return s2;
}
function Io(t2) {
  var _a2, _b, _c, _d;
  ...
  for (const n2 of Pn(t2, as, 1))
    e2.push({x: (_a2 = Gn(n2, 1)) != null ? _a2 : 0, y: (_b = Gn(n2, 2)) != null ? _b : 0, z: (_c = Gn(n2, 3)) != null ? _c : 0, visibility: (_d = Gn(n2, 4)) != null ? _d : 0});
  return e2;
}
function Uo(t2) {
  var _a2, _b, _c, _d;
...
function Qo(t2, e2) {
  ...
  typeof e2 == "string" ? (dn(n2, 2, Me(e2)), dn(n2, 1)) : e2 instanceof Uint8Array && (dn(n2, 1, ae(e2, false, false)), dn(n2, 2)), Cn(t2.baseOptions, 0, 1, n2);
}
function ta(t2) {
  try {
  ...
  l(t2, e2 = true) {
    ...
    if (e2) {
      ...
      if (function(t3, e4) {
        ...
        "delegate" in e4 && (e4.delegate === "GPU" ? (e4 = n2, r2 = new li(), On(e4, 2, Rs, r2)) : (e4 = n2, r2 = new pi(), On(e4, 4, Rs, r2))), Cn(t3.baseOptions, 0, 3, n2);
...
sa.prototype.close = sa.prototype.close, function(e2, n2) {
  e2 = e2.split(".");
  var r2, i2 = t;
  e2[0] in i2 || i2.execScript === void 0 || i2.execScript("var " + e2[0]);
  for (; e2.length && (r2 = e2.shift()); )
    e2.length || n2 === void 0 ? i2 = i2[r2] && i2[r2] !== Object.prototype[r2] ? i2[r2] : i2[r2] = {} : i2[r2] = n2;
}("TaskRunner", sa);
class aa {
  constructor(t2, e2, n2, r2) {
...
function da(t2, e2, n2) {
  return ua(t2, e2), t2 = oa(e2.createTexture(), "Failed to create texture"), e2.bindTexture(e2.TEXTURE_2D, t2), e2.texParameteri(e2.TEXTURE_2D, e2.TEXTURE_WRAP_S, e2.CLAMP_TO_EDGE), e2.texParameteri(e2.TEXTURE_2D, e2.TEXTURE_WRAP_T, e2.CLAMP_TO_EDGE), e2.texParameteri(e2.TEXTURE_2D, e2.TEXTURE_MIN_FILTER, n2 != null ? n2 : e2.LINEAR), e2.texParameteri(e2.TEXTURE_2D, e2.TEXTURE_MAG_FILTER, n2 != null ? n2 : e2.LINEAR), e2.bindTexture(e2.TEXTURE_2D, null), t2;
}
...
var xa, Sa = class {
  constructor(t2, e2, n2, r2, i2, s2, o2) {
    this.g = t2, this.m = e2, this.j = n2, this.canvas = r2, this.l = i2, this.width = s2, this.height = o2, this.j && (--La === 0 && console.error("You seem to be creating MPMask instances without invoking .close(). This leaks resources."));
  }
  Ha() {
    return !!_a(this, 0);
  }
...
var Ka = class {
  constructor(t2, e2, n2, r2, i2, s2, o2) {
    this.g = t2, this.j = e2, this.m = n2, this.canvas = r2, this.l = i2, this.width = s2, this.height = o2, (this.j || this.m) && (--Ya === 0 && console.error("You seem to be creating MPImage instances without invoking .close(). This leaks resources."));
  }
  Ga() {
    return !!Ba(this, 0);
  }
...
const qa = function(t2) {
  ...
  constructor(t2, e2) {
    this.l = true, this.i = t2, this.g = null, this.h = 0, this.m = typeof this.i._addIntToInputStream == "function", e2 !== void 0 ? this.i.canvas = e2 : Ho() ? this.i.canvas = new OffscreenCanvas(1, 1) : (console.warn("OffscreenCanvas not supported and GraphRunner constructor glCanvas parameter is undefined. Creating backup canvas."), this.i.canvas = document.createElement("canvas"));
  }
...
async function Qa(t2, e2, n2) {
  ...
  }(t2, (_a2 = n2.canvas) != null ? _a2 : Ho() ? void 0 : document.createElement("canvas"), e2, n2);
}
function th(t2, e2, n2, r2) {
  if (t2.V) {
    ...
    if (n2 == null ? void 0 : n2.rotationDegrees) {
      ...
      if (Hn(s2, 5, -Math.PI * n2.rotationDegrees / 180), (n2 == null ? void 0 : n2.rotationDegrees) % 180 != 0) {
        const [t3, r3] = zo(e2);
  ...
  t2.g.sa(e2, t2.ba, r2 != null ? r2 : performance.now()), t2.finishProcessing();
}
...
var ih = class extends sa {
  ...
  l(t2, e2 = true) {
    if ("runningMode" in t2 && Vn(this.baseOptions, 2, !!t2.runningMode && t2.runningMode !== "IMAGE"), t2.canvas !== void 0 && this.g.i.canvas !== t2.canvas)
...
var sh = class extends ih {
  ...
  o(t2) {
    var _a2, _b;
    return "minDetectionConfidence" in t2 && Hn(this.h, 2, (_a2 = t2.minDetectionConfidence) != null ? _a2 : 0.5), "minSuppressionThreshold" in t2 && Hn(this.h, 3, (_b = t2.minSuppressionThreshold) != null ? _b : 0.3), this.l(t2);
  }
  F(t2, e2) {
...
var yh = class extends ih {
  ...
  o(t2) {
    var _a2, _b, _c, _d;
    return "numFaces" in t2 && Xn(this.j, 4, (_a2 = t2.numFaces) != null ? _a2 : 1), "minFaceDetectionConfidence" in t2 && Hn(this.j, 2, (_b = t2.minFaceDetectionConfidence) != null ? _b : 0.5), "minTrackingConfidence" in t2 && Hn(this.h, 4, (_c = t2.minTrackingConfidence) != null ? _c : 0.5), "minFacePresenceConfidence" in t2 && Hn(this.H, 2, (_d = t2.minFacePresenceConfidence) != null ? _d : 0.5), "outputFaceBlendshapes" in t2 && (this.outputFaceBlendshapes = !!t2.outputFaceBlendshapes), "outputFacialTransformationMatrixes" in t2 && (this.outputFacialTransformationMatrixes = !!t2.outputFacialTransformationMatrixes), this.l(t2);
  }
  F(t2, e2) {
  ...
  m() {
    ...
    ki(n2, "mediapipe.tasks.vision.face_landmarker.FaceLandmarkerGraph"), xi(n2, "IMAGE:image_in"), xi(n2, "NORM_RECT:norm_rect"), Si(n2, "NORM_LANDMARKS:face_landmarks"), n2.o(e2), Oi(t2, n2), this.g.attachProtoVectorListener("face_landmarks", (t3, e3) => {
      ...
      if (this.outputFaceBlendshapes)
        for (const e4 of t3)
          t3 = Wi(e4), this.u.faceBlendshapes.push(Co((_a2 = t3.g()) != null ? _a2 : []));
      ea(this, e3);
      ...
      if (this.outputFacialTransformationMatrixes)
        for (const e4 of t3)
          (t3 = Rn(Gs(e4), ls, 2)) && this.u.facialTransformationMatrixes.push({rows: (_a2 = Bn(Nn(t3, 1), 0)) != null ? _a2 : 0, columns: (_b = Bn(Nn(t3, 2), 0)) != null ? _b : 0, data: (_c = yn(t3, 3, ve).slice()) != null ? _c : []});
      ea(this, e3);
...
var _h = class extends ih {
  ...
  Pa(t2, e2, n2) {
    ...
    if (this.h = typeof e2 == "function" ? e2 : n2, eh(this, t2, r2 != null ? r2 : {}), !this.h)
      return this.u;
  }
  m() {
    var t2 = new Di();
...
function Th(t2, e2 = true) {
  ...
  for (const i2 of t2) {
    ...
    for (const n3 of r2.g())
      r2 = e2 && Nn(n3, 1) != null ? Bn(Nn(n3, 1), 0) : -1, t2.push({score: (_a2 = Gn(n3, 2)) != null ? _a2 : 0, index: r2, categoryName: (_b = jn(n3, 3)) != null ? _b : "", displayName: (_c = jn(n3, 4)) != null ? _c : ""});
    n2.push(t2);
  }
  return n2;
}
var Ah = class extends ih {
  ...
  o(t2) {
    ...
    if (Xn(this.h, 3, (_a2 = t2.numHands) != null ? _a2 : 1), "minHandDetectionConfidence" in t2 && Hn(this.h, 2, (_b = t2.minHandDetectionConfidence) != null ? _b : 0.5), "minTrackingConfidence" in t2 && Hn(this.A, 4, (_c = t2.minTrackingConfidence) != null ? _c : 0.5), "minHandPresenceConfidence" in t2 && Hn(this.u, 2, (_d = t2.minHandPresenceConfidence) != null ? _d : 0.5), t2.cannedGesturesClassifierOptions) {
      var e2 = new $s(), n2 = e2, r2 = Po(t2.cannedGesturesClassifierOptions, (_e2 = Rn(this.j, $s, 3)) == null ? void 0 : _e2.h());
      Cn(n2, 0, 2, r2), Cn(this.j, 0, 3, e2);
    } else
      t2.cannedGesturesClassifierOptions === void 0 && ((_f = Rn(this.j, $s, 3)) == null ? void 0 : _f.g());
    return t2.customGesturesClassifierOptions ? (Cn(n2 = e2 = new $s(), 0, 2, r2 = Po(t2.customGesturesClassifierOptions, (_g = Rn(this.j, $s, 4)) == null ? void 0 : _g.h())), Cn(this.j, 0, 4, e2)) : t2.customGesturesClassifierOptions === void 0 && ((_h2 = Rn(this.j, $s, 4)) == null ? void 0 : _h2.g()), this.l(t2);
  }
  Ka(t2, e2) {
    ...
    ki(n2, "mediapipe.tasks.vision.gesture_recognizer.GestureRecognizerGraph"), xi(n2, "IMAGE:image_in"), xi(n2, "NORM_RECT:norm_rect"), Si(n2, "HAND_GESTURES:hand_gestures"), Si(n2, "LANDMARKS:hand_landmarks"), Si(n2, "WORLD_LANDMARKS:world_hand_landmarks"), Si(n2, "HANDEDNESS:handedness"), n2.o(e2), Oi(t2, n2), this.g.attachProtoVectorListener("hand_landmarks", (t3, e3) => {
      ...
      for (const e4 of t3) {
        ...
        for (const e5 of Pn(t3, as, 1))
          n3.push({x: (_a2 = Gn(e5, 1)) != null ? _a2 : 0, y: (_b = Gn(e5, 2)) != null ? _b : 0, z: (_c = Gn(e5, 3)) != null ? _c : 0, visibility: (_d = Gn(e5, 4)) != null ? _d : 0});
...
var kh = class extends ih {
  ...
  o(t2) {
    var _a2, _b, _c, _d;
    return "numHands" in t2 && Xn(this.h, 3, (_a2 = t2.numHands) != null ? _a2 : 1), "minHandDetectionConfidence" in t2 && Hn(this.h, 2, (_b = t2.minHandDetectionConfidence) != null ? _b : 0.5), "minTrackingConfidence" in t2 && Hn(this.j, 4, (_c = t2.minTrackingConfidence) != null ? _c : 0.5), "minHandPresenceConfidence" in t2 && Hn(this.u, 2, (_d = t2.minHandPresenceConfidence) != null ? _d : 0.5), this.l(t2);
  }
  F(t2, e2) {
    ...
    ki(n2, "mediapipe.tasks.vision.hand_landmarker.HandLandmarkerGraph"), xi(n2, "IMAGE:image_in"), xi(n2, "NORM_RECT:norm_rect"), Si(n2, "LANDMARKS:hand_landmarks"), Si(n2, "WORLD_LANDMARKS:world_hand_landmarks"), Si(n2, "HANDEDNESS:handedness"), n2.o(e2), Oi(t2, n2), this.g.attachProtoVectorListener("hand_landmarks", (t3, e3) => {
      ...
      for (const e4 of t3) {
        ...
        for (const e5 of t3.g())
          n4.push({score: (_a2 = Gn(e5, 2)) != null ? _a2 : 0, index: (_b = Bn(Nn(e5, 1), 0)) != null ? _b : -1, categoryName: (_c = jn(e5, 3)) != null ? _c : "", displayName: (_d = jn(e5, 4)) != null ? _d : ""});
        i2.push(n4);
      }
...
var Rh = class extends ih {
  ...
  o(t2) {
    ...
    return "minFaceDetectionConfidence" in t2 && Hn(this.j, 2, (_a2 = t2.minFaceDetectionConfidence) != null ? _a2 : 0.5), "minFaceSuppressionThreshold" in t2 && Hn(this.j, 3, (_b = t2.minFaceSuppressionThreshold) != null ? _b : 0.3), "minFacePresenceConfidence" in t2 && Hn(this.H, 2, (_c = t2.minFacePresenceConfidence) != null ? _c : 0.5), "outputFaceBlendshapes" in t2 && (this.outputFaceBlendshapes = !!t2.outputFaceBlendshapes), "minPoseDetectionConfidence" in t2 && Hn(this.v, 2, (_d = t2.minPoseDetectionConfidence) != null ? _d : 0.5), "minPoseSuppressionThreshold" in t2 && Hn(this.v, 3, (_e2 = t2.minPoseSuppressionThreshold) != null ? _e2 : 0.3), "minPosePresenceConfidence" in t2 && Hn(this.D, 2, (_f = t2.minPosePresenceConfidence) != null ? _f : 0.5), "outputPoseSegmentationMasks" in t2 && (this.outputPoseSegmentationMasks = !!t2.outputPoseSegmentationMasks), "minHandLandmarksConfidence" in t2 && Hn(this.u, 2, (_g = t2.minHandLandmarksConfidence) != null ? _g : 0.5), this.l(t2);
  }
  F(t2, e2, n2) {
    const r2 = typeof e2 != "function" ? e2 : {};
    return this.I = typeof e2 == "function" ? e2 : n2, Sh(this), eh(this, t2, r2), Lh(this);
  }
  G(t2, e2, n2, r2) {
    const i2 = typeof n2 != "function" ? n2 : {};
    return this.I = typeof n2 == "function" ? n2 : r2, Sh(this), nh(this, t2, i2, e2), Lh(this);
  }
  m() {
    var t2 = new Di();
    ...
    An(n2, 1, Me("type.googleapis.com/mediapipe.tasks.vision.holistic_landmarker.proto.HolisticLandmarkerGraphOptions"), ""), function(t3, e3) {
      if (e3 != null)
        if (Array.isArray(e3))
          ...
          if (!(typeof e3 == "string" || e3 instanceof B || M(e3)))
    ...
    ki(r2, "mediapipe.tasks.vision.holistic_landmarker.HolisticLandmarkerGraph"), Dn(r2, 8, oi, n2), xi(r2, "IMAGE:input_frames_image"), Si(r2, "POSE_LANDMARKS:pose_landmarks"), Si(r2, "POSE_WORLD_LANDMARKS:pose_world_landmarks"), Si(r2, "FACE_LANDMARKS:face_landmarks"), Si(r2, "LEFT_HAND_LANDMARKS:left_hand_landmarks"), Si(r2, "LEFT_HAND_WORLD_LANDMARKS:left_hand_world_landmarks"), Si(r2, "RIGHT_HAND_LANDMARKS:right_hand_landmarks"), Si(r2, "RIGHT_HAND_WORLD_LANDMARKS:right_hand_world_landmarks"), r2.o(e2), Oi(t2, r2), na(this, t2), this.g.attachProtoListener("pose_landmarks", (t3, e3) => {
      ...
      this.outputFaceBlendshapes && (t3 = Wi(t3), n3.push(Co((_a2 = t3.g()) != null ? _a2 : []))), ea(this, e3);
    ...
    ki(n2, "mediapipe.tasks.vision.image_classifier.ImageClassifierGraph"), xi(n2, "IMAGE:input_image"), xi(n2, "NORM_RECT:norm_rect"), Si(n2, "CLASSIFICATIONS:classifications"), n2.o(e2), Oi(t2, n2), this.g.attachProtoListener("classifications", (t3, e3) => {
      this.j = function(t4) {
        const e4 = {classifications: Pn(t4, ps, 1).map((t5) => {
          var _a2, _b;
          return Co((_b = (_a2 = Rn(t5, Xi, 4)) == null ? void 0 : _a2.g()) != null ? _b : [], Bn(Nn(t5, 2), 0), jn(t5, 3));
        })};
        return Fe(cn(t4, 2)) != null && (e4.timestampMs = Bn(Fe(cn(t4, 2)), 0)), e4;
      }(ys(t3)), ea(this, e3);
...
var Ph = class extends ih {
  ...
  o(t2) {
    ...
    return n2 = n2 ? n2.clone() : new Ss(), t2.l2Normalize !== void 0 ? Vn(n2, 1, t2.l2Normalize) : "l2Normalize" in t2 && dn(n2, 1), t2.quantize !== void 0 ? Vn(n2, 2, t2.quantize) : "quantize" in t2 && dn(n2, 2), Cn(e2, 0, 2, n2), this.l(t2);
  }
  Ba(t2, e2) {
    ...
    ki(n2, "mediapipe.tasks.vision.image_embedder.ImageEmbedderGraph"), xi(n2, "IMAGE:image_in"), xi(n2, "NORM_RECT:norm_rect"), Si(n2, "EMBEDDINGS:embeddings_out"), n2.o(e2), Oi(t2, n2), this.g.attachProtoListener("embeddings_out", (t3, e3) => {
      t3 = bs(t3), this.embeddings = function(t4) {
        return {embeddings: Pn(t4, Es, 1).map((t5) => {
          ...
          const e4 = {headIndex: (_a2 = Bn(Nn(t5, 3), 0)) != null ? _a2 : -1, headName: (_b = jn(t5, 4)) != null ? _b : ""};
          if (Fn(t5, _s, xn(t5, 1)) !== void 0)
            t5 = yn(t5 = Rn(t5, _s, xn(t5, 1)), 1, ve), e4.floatEmbedding = t5.slice();
          else {
            const n3 = new Uint8Array(0);
            e4.quantizedEmbedding = (_e2 = (_d = (_c = Rn(t5, vs, xn(t5, 2))) == null ? void 0 : _c.qa()) == null ? void 0 : _d.h()) != null ? _e2 : n3;
          }
          return e4;
...
var Uh = class extends ih {
  ...
  L() {
    !function(t2) {
      ...
      e2.length === 1 && ((_c = (_b = (_a2 = Rn(e2[0], yi, 7)) == null ? void 0 : _a2.l()) == null ? void 0 : _b.g()) != null ? _c : new Map()).forEach((e3, n2) => {
  ...
  ga(t2, e2, n2) {
    const r2 = typeof e2 != "function" ? e2 : {};
    return this.j = typeof e2 == "function" ? e2 : n2, Oh(this), eh(this, t2, r2), Ih(this);
  }
  Na(t2, e2, n2, r2) {
    const i2 = typeof n2 != "function" ? n2 : {};
    return this.j = typeof n2 == "function" ? n2 : r2, Oh(this), nh(this, t2, i2, e2), Ih(this);
  }
  Fa() {
    return this.u;
  }
...
var rc = class extends ih {
  ...
  ga(t2, e2, n2, r2) {
    const i2 = typeof n2 != "function" ? n2 : {};
    this.j = typeof n2 == "function" ? n2 : r2, this.qualityScores = this.categoryMask = this.confidenceMasks = void 0, n2 = this.J + 1, r2 = new nc();
    const s2 = new Zh();
    var o2 = new Nh();
...
var ic = class extends ih {
  ...
  o(t2) {
    return t2.displayNamesLocale !== void 0 ? dn(this.h, 2, Me(t2.displayNamesLocale)) : "displayNamesLocale" in t2 && dn(this.h, 2), t2.maxResults !== void 0 ? Xn(this.h, 3, t2.maxResults) : "maxResults" in t2 && dn(this.h, 3), t2.scoreThreshold !== void 0 ? Hn(this.h, 4, t2.scoreThreshold) : "scoreThreshold" in t2 && dn(this.h, 4), t2.categoryAllowlist !== void 0 ? Tn(this.h, 5, t2.categoryAllowlist) : "categoryAllowlist" in t2 && dn(this.h, 5), t2.categoryDenylist !== void 0 ? Tn(this.h, 6, t2.categoryDenylist) : "categoryDenylist" in t2 && dn(this.h, 6), this.l(t2);
  }
  F(t2, e2) {
    return this.j = {detections: []}, eh(this, t2, e2), this.j;
  }
...
var hc = class extends ih {
  ...
  o(t2) {
    var _a2, _b, _c, _d, _e2;
    return "numPoses" in t2 && Xn(this.v, 4, (_a2 = t2.numPoses) != null ? _a2 : 1), "minPoseDetectionConfidence" in t2 && Hn(this.v, 2, (_b = t2.minPoseDetectionConfidence) != null ? _b : 0.5), "minTrackingConfidence" in t2 && Hn(this.h, 4, (_c = t2.minTrackingConfidence) != null ? _c : 0.5), "minPosePresenceConfidence" in t2 && Hn(this.D, 2, (_d = t2.minPosePresenceConfidence) != null ? _d : 0.5), "outputSegmentationMasks" in t2 && (this.outputSegmentationMasks = (_e2 = t2.outputSegmentationMasks) != null ? _e2 : false), this.l(t2);
  }
  F(t2, e2, n2) {
    const r2 = typeof e2 != "function" ? e2 : {};
    return this.j = typeof e2 == "function" ? e2 : n2, oc(this), eh(this, t2, r2), ac(this);
  }
  G(t2, e2, n2, r2) {
    const i2 = typeof n2 != "function" ? n2 : {};
    return this.j = typeof n2 == "function" ? n2 : r2, oc(this), nh(this, t2, i2, e2), ac(this);
  }
  m() {
    var t2 = new Di();
